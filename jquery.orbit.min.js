(function(e){e.fn.orbit=function(a){a=e.extend({animation:"fade",animationSpeed:1000,timer:true,advanceSpeed:5E3,pauseOnHover:false,startClockOnMouseOut:false,startClockOnMouseOutAfter:0,directionalNav:false,captions:false,captionAnimation:"fade",captionAnimationSpeed:800,bullets:false,bulletThumbs:false,bulletThumbLocation:"",afterSlideChange:function(){}},a);return this.each(function(){function t(){if(a.timer)if(u.is(":hidden"))v=setInterval(function(){o("next")},a.advanceSpeed);else{r=true;A.removeClass("active");
